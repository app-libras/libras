...
//   Map<Type, List<int>> allOffsets,
// ) {
//   writer.writeLong(offsets[0], object.avatar);
...
// ) {
//   final object = User();
//   object.avatar = reader.readLong(offsets[0]);
//   object.id = id;
...
//   QueryBuilder<User, User, QAfterFilterCondition> avatarEqualTo(int value) {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, User, QAfterFilterCondition> scoreEqualTo(int value) {
//     return QueryBuilder.apply(this, (query) {
//       return query.addFilterCondition(FilterCondition.equalTo(
//         property: r'score',
//         value: value,
...
//   QueryBuilder<User, User, QAfterFilterCondition> scoreGreaterThan(
//     int value, {
//     bool include = false,
//   }) {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, User, QAfterFilterCondition> scoreLessThan(
//     int value, {
//     bool include = false,
//   }) {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, User, QAfterFilterCondition> scoreBetween(
//     int lower,
//     int upper, {
//     bool includeLower = true,
//     bool includeUpper = true,
...
//   QueryBuilder<User, User, QAfterSortBy> sortByScore() {
//     return QueryBuilder.apply(this, (query) {
//       return query.addSortBy(r'score', Sort.asc);
//     });
//   }

//   QueryBuilder<User, User, QAfterSortBy> sortByScoreDesc() {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, User, QAfterSortBy> thenByScore() {
//     return QueryBuilder.apply(this, (query) {
//       return query.addSortBy(r'score', Sort.asc);
//     });
//   }

//   QueryBuilder<User, User, QAfterSortBy> thenByScoreDesc() {
//     return QueryBuilder.apply(this, (query) {
//       return query.addSortBy(r'score', Sort.desc);
//     });
//   }
...
//   QueryBuilder<User, User, QDistinct> distinctByScore() {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, int, QQueryOperations> avatarProperty() {
//     return QueryBuilder.apply(this, (query) {
...
//   QueryBuilder<User, int, QQueryOperations> scoreProperty() {
//     return QueryBuilder.apply(this, (query) {
